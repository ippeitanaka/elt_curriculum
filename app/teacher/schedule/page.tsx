...
export default function TeacherSchedule() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">講師用スケジュール</h1>
      ...
      <div className="mb-6 space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition-colors duration-200 hover:border-gray-400"
              >
        ...
        {/* フィルター状態表示 */}
        {(selectedInstructor !== "全て" || selectedSubject !== "全て") && (
          <div className="bg-blue-50 border border-blue-200 rounded-md p-3">
            <div className="flex items-center">
              ...
              <span className="text-sm text-blue-700">
                フィルター適用中: 
                {selectedInstructor !== "全て" && ` 講師「${selectedInstructor}」`}
                {selectedInstructor !== "全て" && selectedSubject !== "全て" && " + "}
                {selectedSubject !== "全て" && ` 授業「${selectedSubject}」`}
              </span>
              <button
                onClick={() => {
                  setSelectedInstructor("全て")
